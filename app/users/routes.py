...
async def get_my_profile(user_id: str = Depends(get_current_user_id)):
    ...
    return create_response(data=user, messages="User profile retrieved successfully")
...
async def update_my_profile(
    ...
    user = controller.update_user_profile(user_id, updates)
    return create_response(data=user, messages="User profile updated successfully")
